...
#ifndef nealcoin_WALLET_WALLET_H
#define nealcoin_WALLET_WALLET_H
...
public:
     ...
     * on this nealcoin node, and set to 0 for transactions that were created
...
#endif // nealcoin_WALLET_WALLET_H
