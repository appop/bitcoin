...
#ifndef nealcoin_QT_nealcoinUNITS_H
#define nealcoin_QT_nealcoinUNITS_H
...
/** nealcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class nealcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit nealcoinUnits(QObject *parent);

    /** nealcoin units.
      @note Source: https://en.nealcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef nealcoinUnits::Unit nealcoinUnit;

#endif // nealcoin_QT_nealcoinUNITS_H
