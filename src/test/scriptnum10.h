...
#ifndef nealcoin_TEST_SCRIPTNUM10_H
#define nealcoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from nealcoin Core 0.10.0, for cross-comparison.
 */
public:
