...
#define BOOST_TEST_MODULE nealcoin Test Suite

#include "test_nealcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_nealcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
