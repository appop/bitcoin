nealcoin Core version 0.9.4 is now available from:

  https://nealcoin.org/bin/0.9.4/
...
this update is incompatible with the nealcoin system and could lead to consensus
forks.

nealcoin Core released binaries from https://nealcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nealcoin/+archive/ubuntu/nealcoin
- A third-party or self-compiled nealcoin Core

upgrade to nealcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
