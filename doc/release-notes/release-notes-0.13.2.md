nealcoin Core version 0.13.2 is now available from:

  <https://nealcoin.org/bin/nealcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update nealcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nealcoin-tx to create v2 transactions (btcdrak)
