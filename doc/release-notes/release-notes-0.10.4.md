nealcoin Core version 0.10.4 is now available from:

  <https://nealcoin.org/bin/nealcoin-core-0.10.4/>
...
- #6953 `43c2789` Split nealcoin-tx into its own package
- #6953 `dfe0d4d` Include nealcoin-tx binary on Debian/Ubuntu
