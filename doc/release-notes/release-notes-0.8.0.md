nealcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nealcoin/files/nealcoin/nealcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the nealcoin
...
New/changed settings (command-line or nealcoin.conf file)
--------------------------------------------------------
