nealcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/nealcoin/files/nealcoin/nealcoin-0.5.4/
...
http://gitorious.org/nealcoin/nealcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix nealcoin-Qt notifications under Growl 1.3.
Increase required age of nealcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxnealcoin properly when installing nealcoin-Qt over it. (Windows)
