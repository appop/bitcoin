...
unlocked to sign the nealcoin-Qt.app bundle.
...
allowing somebody to distribute a nealcoin-Qt.app or nealcoin-qt-setup.exe with a valid
...
that the nealcoin-qt.exe file inside the installer had not been tampered with.
