#!/usr/bin/env python3
# Copyright (c) 2017 The nealcoin Core developers
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if nealcoind ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(nealcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 1
