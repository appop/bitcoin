...
# TestNode: A peer we use to send messages to nealcoind, and store responses.
...
class CompactBlocksTest(nealcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes nealcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nealcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for nealcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # nealcoind will not send blocktxn responses for blocks whose height is
